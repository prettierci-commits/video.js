module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    minify: {
      source: {
        src: [
          "build/files/combined.video.js",
          "build/compiler/goog.base.js",
          "src/js/exports.js"
        ],
  ...
  grunt.registerMultiTask("build", "Building Source", function() {
    ...
    grunt.file.recurse("src/css/font", function(
      absdir,
      rootdir,
      subdir,
      filename
    ...
    function() {
      ...
      if (this.data.sourcelist) {
        filePatterns = filePatterns.concat(
          grunt.file.read(this.data.sourcelist).split(",")
        );
      }
      if (this.data.src) {
      ...
      var command =
        ...
        " --create_source_map " +
        dest +
        ".map --source_map_format=V3" +
        " --jscomp_warning=checkTypes --warning_level=VERBOSE" +
        ' --output_wrapper "/*! Video.js v' +
        version.full +
        " " +
        pkg.copyright +
  ...
  grunt.registerTask("dist", "Creating distribution", function() {
    ...
    grunt.file.copy(
      "build/demo-files/demo.captions.vtt",
      "dist/video-js/demo.captions.vtt"
    );

    // Copy over font files
    grunt.file.recurse("build/files/font", function(
      absdir,
      rootdir,
      subdir,
      filename
    ...
    cdnjs = uglify
      .minify("src/js/cdn.js")
      .code.replace("v0.0.0", "v" + version.full);
    grunt.file.write("dist/cdn/video.js", jsmin + cdnjs);

    // Zip up into video-js-VERSION.zip
    exec(
      "cd dist && zip -r video-js-" + version.full + ".zip video-js && cd ..",
      { maxBuffer: 500 * 1024 },
