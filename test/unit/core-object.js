...
test("should verify CoreObject extension", function() {
  ...
  ok(
    instance instanceof vjs.CoreObject,
    "New instance is instance of CoreObject"
  );
  ok(instance["a"], "Init options are passed to init");
  ok(
    instance.testFn(),
    "Additional methods are applied to TestObject prototype"
  );
  ...
  ok(
    childInstance instanceof TestChild,
    "New instance is instance of TestChild"
  );
  ok(
    childInstance instanceof TestObject,
    "New instance is instance of TestObject"
  );
  ok(
    childInstance instanceof vjs.CoreObject,
    "New instance is instance of CoreObject"
  );
  ...
  ok(
    TestObject.prototype.testFn() === true,
    "Prototype of parent not overridden"
  );
});
