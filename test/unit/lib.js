...
test("should get and remove data from an element", function() {
  ...
  ok(
    el[vjs.expando] === null || el[vjs.expando] === undefined,
    "element data id removed"
  );
});
...
test("should read tag attributes from elements, including HTML5 in all browsers", function() {
  ...
  deepEqual(vid1Vals, {
    ...
    loop: true,
    muted: true,
    poster: "http://www2.videojs.com/img/video-js-html5-video-player.png",
    preload: "none",
    src: "http://google.com"
  });
  deepEqual(vid2Vals, { id: "vid2" });
  deepEqual(sourceVals, {
    title: "test",
    media: "fdsa",
    type: "video/mp4",
    src: "http://google.com",
  ...
  deepEqual(trackVals, {
    default: true,
    /* IE no likey default key */ id: "track",
    kind: "captions",
    label: "testlabel",
    src: "http://google.com",
    srclang: "en",
...
test("should get an absolute URL", function() {
  ...
  ok(
    vjs.getAbsoluteURL("https://asdf.com/index.html") ===
